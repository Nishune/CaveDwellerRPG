...
public class Game {
    ...
    public Game(World world, Location currentLocation, Scanner scanner, Player player, boolean running) {
        ...
        this.inventoryController = new InventoryController(player, scanner);
    }
    ...
    public void start() {
        ...
        while (running) {
            ...
            switch (input) {
                case "inventory":
                case "i":
                    inventoryController.showInteractiveInventory();
                    displayControls();
                    break;
                case "character":
                case "c":
                    inventoryController.showInteractiveCharacter();
                    displayControls();
                    break;
                case "open":
                case "o":
